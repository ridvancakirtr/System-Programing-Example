...
Exercise 2: Develop a program that gets 5 product names and prices from user. Then,
...
Exercise 3: Develop a program that gets N student numbers and names with HashMap.
...
Exercise 4: Develop a program for car repair services, which takes the spare part name
...
Exercise 5: Develop a program that gets 5 student numbers and quiz grades from user,
